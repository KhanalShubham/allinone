    ...
    <div className="max-w-lg mx-auto px-4 py-10">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex items-center gap-3 mb-6 pb-5 border-b border-gray-100">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-red-500 to-rose-600 shadow-md flex items-center justify-center">
            <Music size={22} className="text-white" />
          </div>
          <div>
            <h1 className="text-xl font-bold text-gray-900">YouTube to MP3</h1>
            <p className="text-sm text-gray-500">Extract audio from any YouTube video</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            {loading ? 'Fetching audio... this may take a moment' : 'Download MP3'}
          </button>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 text-sm text-blue-800">
            Audio is saved in the best available format (usually .m4a). Install FFmpeg on the server for true .mp3 conversion.
          </div>
