    ...
    <div className="max-w-lg mx-auto px-4 py-10">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-700 flex items-center justify-center shadow-md">
            <Link2 size={24} className="text-white" />
          </div>
          <div>
            <h1 className="text-xl font-bold text-gray-900">URL Encoder / Decoder</h1>
            <p className="text-sm text-gray-500">Encode or decode URLs and query strings</p>
          </div>
        </div>
